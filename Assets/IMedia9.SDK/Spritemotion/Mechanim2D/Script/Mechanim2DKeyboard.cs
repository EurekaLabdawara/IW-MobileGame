...
namespace IMedia9
{
    ...
    public class Mechanim2DKeyboard : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (MovementType == CMovementType.VelocityAllDirection)
            {
                TargetController.gravityScale = 0;
            }
        }
        ...
        void FixedUpdate()
        {
            ...
            if (MovementType == CMovementType.VelocityAllDirection)
            {
                ...
                {
                    vSpeed = Vector2.right * MoveSpeed * Time.fixedDeltaTime;
                    this.transform.Rotate(0, 0, -rotateVector * (RotateSpeed * Time.deltaTime));
                }
                if (horizontalMove < 0)
                {
                    vSpeed = Vector2.right * MoveSpeed * Time.fixedDeltaTime;
                ...
                if (verticalMove > 0)
                {
                    vSpeed = this.transform.right * MoveSpeed * Time.fixedDeltaTime;
                    TargetController.position = TargetController.position + vSpeed;
                }
                if (verticalMove < 0)
                {
