...
namespace IMedia9
{
    [CustomEditor(typeof(DisplayHealthSprite)), CanEditMultipleObjects]
    public class DisplayHealthSpriteEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            playerobject_prop = serializedObject.FindProperty("PlayerObject");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(playerobject_prop, new GUIContent("PlayerObject"));
